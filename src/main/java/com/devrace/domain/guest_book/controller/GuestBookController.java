...
public class GuestBookController {
    ...
    @PatchMapping
    public ResponseEntity<Void> updateContent(@AuthenticationPrincipal Long userId, @Valid @RequestBody ContentUpdateRequest request) {
        guestBookService.updateContent(userId, request);
